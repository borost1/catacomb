...
catacomb_facts = [
    ...
    "The largest catacomb in the world is the Catacombs of Rome, which spans over 590 acres and contains approximately 150,000 burial sites.",
    "The Catacombs of Paris are another famous catacomb system, and contain the remains of an estimated 6 million people.",
    "Catacombs were often used to bury persecuted Christians in ancient Rome, and many early Christian martyrs were buried in the catacombs.",
    ...
    "The name of that place in Late Latin was L.L. fem. nom. pl. n. catacumbas (sing. catacumba) a word of obscure origin, "
    ...
    "Most aircraft at boneyards are either kept for storage with some maintenance or have their parts removed for reuse or resale and are then scrapped.",
    "A tzompantli or skull rack was a type of wooden rack or palisade documented in several Mesoamerican civilizations which was used for the public display of human skulls,"
